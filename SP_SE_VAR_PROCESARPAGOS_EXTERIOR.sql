...
DECLARE NUMIDFACTURAPRIMERA NUMERIC (12, 0) DEFAULT 0;
...
END;
DECLARE CONTINUE HANDLER FOR SQLSTATE '75000' BEGIN
SET CHRPROSEGUIR = 'N';
...
SELECT DATE (
        CAST (CNTRDY + 2000 AS CHAR (4)) || '-' || CNTRDM || '-' || CNTRDD
    ) INTO DATFECHAACTUAL
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    0,
    0,
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA || ' | MONEDAFACTURA: ' || MONEDAFACTURA || ' | MONTO: ' || MONTO || ' | FECHAEMISION: ' || FECHAEMISION || ' | FECHAPAGO: ' || FECHAPAGO || ' | ESTADOFACTURA: ' || ESTADOFACTURA || ' | FORMAPAGO: ' || FORMAPAGO || ' | CTAPAGADOR: ' || CTAPAGADOR || ' | NUMCTAPAGADOR_ANT: ' || NUMCTAPAGADOR_ANT || ' | NUMIDBENEFICIARIO_ANT: ' || NUMIDBENEFICIARIO_ANT || ' | IDUNICOBENEFICIARIO: ' || IDUNICOBENEFICIARIO || ' | CIFPAGADOR: ' || CIFPAGADOR || ' | MONEDACUENTABENEFICIARIO: ' || MONEDACUENTABENEFICIARIO || ' | CUENTABENEFICIARIO: ' || CUENTABENEFICIARIO || ' | TIPO: ' || TIPO
);
--CAMBIO_SOLICITADO_ANTIGRAVITY--
IF NUMCTAPAGADOR_ANT IS NULL
OR NUMCTAPAGADOR_ANT <> CICLOFACTURAS.CTAPAGADOR
OR NUMIDBENEFICIARIO_ANT <> CICLOFACTURAS.IDUNICOBENEFICIARIO
OR NUMFORMAPAGO_ANT <> CICLOFACTURAS.FORMAPAGO
OR CHRMONEDAFACTURA_ANT <> CICLOFACTURAS.MONEDAFACTURA
OR NUMTIPO <> CICLOFACTURAS.TIPO THEN -- Si el beneficiario actual es diferente al anterior (y no es la primera vez), enviamos lo acumulado.
--FIN_CAMBIO_SOLICITADO_ANTIGRAVITY--
IF NUMIDBENEFICIARIO_ANT IS NOT NULL
AND (
    NUMIDBENEFICIARIO_ANT <> CICLOFACTURAS.IDUNICOBENEFICIARIO
    OR NUMCTAPAGADOR_ANT <> CICLOFACTURAS.CTAPAGADOR
    OR CHRMONEDAFACTURA_ANT <> CICLOFACTURAS.MONEDAFACTURA
) THEN CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    0,
    0,
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - ENTRA A CICLO SON IGUALES - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA || ' | NUMCTAPAGADOR_ANT: ' || NUMCTAPAGADOR_ANT || ' | CTAPAGADOR: ' || CTAPAGADOR || ' | NUMIDBENEFICIARIO_ANT: ' || NUMIDBENEFICIARIO_ANT || ' | IDUNICOBENEFICIARIO: ' || IDUNICOBENEFICIARIO || ' | DECMONTODEBITO: ' || DECMONTODEBITO || ' | NUMFORMAPAGO_ANT: ' || NUMFORMAPAGO_ANT || ' | NUMTIPO: ' || NUMTIPO
);
SET CHRPROSEGUIR = 'S';
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - ENTRA A CICLO FORMAPAGO 3 Y TIPO 2 - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA
);
IF DECMONTODEBITO > 0 THEN IF NUMFORMAPAGO_ANT = 3
AND NUMTIPO <> 2 THEN CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    0,
    0,
...
SET VARDESCRIPCIONDEBITO = SUBSTRING (
        TRIM (VARNOMBREBENEFICIARIO) || ' ' || TRIM (CHAR (INTCONTADORFACTOK)) || ' FACTURAS',
        1,
        30
    );
...
SET VARDESCRIPCIONCREDITO = SUBSTRING (
        TRIM (VARNOMBREPAGADOR) || ' ' || TRIM (CHAR (INTCONTADORFACTOK)) || ' FACTURAS',
        1,
        30
    );
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ENTRA A CONSULTA FACTURASEXTERIOR 1 ' || CICLOFACTURAS.IDUNICOFACTURA || ' | PARAM NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA
);
...
WHERE CUSCUN = CICLOFACTURAS.CIFPAGADOR;
--FIN_CAMBIO_SOLICITADO_ANTIGRAVITY--
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR1 - CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | INTTIPORESULTADO: ' || INTTIPORESULTADO || ' | VARMENSAJERESULTADO: ' || VARMENSAJERESULTADO
);
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - NOOO ENTRA A CICLO FORMAPAGO 3 Y TIPO 2 - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA
);
...
DELETE FROM SESSION.PGCOLANOTIFICACIONESTMP;
END IF;
SET CHRHORA = REPLACE (CHAR (CURRENT TIME), ':', '');
...
SET CHRDOCUMENTOIDENTIDADBENEFICIARIO = CICLOFACTURAS.DOCUMENTOIDENTIDADBENEFICIARIO;
SET NUMCTAPAGADOR_ANT = CICLOFACTURAS.CTAPAGADOR;
SET NUMIDBENEFICIARIO_ANT = CICLOFACTURAS.IDUNICOBENEFICIARIO;
SET NUMIDFACTURAPRIMERA = CICLOFACTURAS.IDUNICOFACTURA;
...
SET NUMCIFBENEFICIARIO = CICLOFACTURAS.CIFBENEFICIARIO;
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ANTES DE AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | TOTAL FACTURAS: ' || INTTOTALFACT
);
SET NUMIDUNICOFACTURA = IDUNICOFACTURA;
--** Se lleva el conteo de total de facturas por grupo 
SET INTTOTALFACT = INTTOTALFACT + 1;
IF CHRPROSEGUIR = 'S' THEN CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    0,
    0,
...
END IF;
--CAMBIO_SOLICITADO_ANTIGRAVITY--
SET NUMUSUARIO = CICLOFACTURAS.CIFPAGADOR;
SET DECMONTO = CICLOFACTURAS.MONTO;
SET CHRCODMONEDA = CICLOFACTURAS.MONEDAFACTURA;
--FIN_CAMBIO_SOLICITADO_ANTIGRAVITY--
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - PREVIO A INTOPCIONTC AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA
);
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - VALIDA SALDO AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | NUMSALDODISPONIBLECUENTA: ' || NUMSALDODISPONIBLECUENTA
);
...
END IF;
ELSE CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    CICLOFACTURAS.IDUNICOFACTURA,
    0,
    0,
    0,
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - PROCSEGUIR N AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA
);
UPDATE BLHCYFILES.TB_SE_TRN_PGTRANSACCIONESFACTURAS
SET ESTADOPROCESO = 0,
    ESTADOFACTURA = (
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LINEA | NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA || ' | IDUNICOFACTURA: - | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA
);
IF DECMONTODEBITO > 0 THEN IF NUMFORMAPAGO_ANT = 3
AND NUMTIPO <> 2 THEN
SET VARDESCRIPCIONDEBITO = SUBSTRING (
        TRIM (VARNOMBREBENEFICIARIO) || ' ' || CAST (INTCONTADORFACTOK AS VARCHAR (30)) || ' FACTURAS',
        0,
        30
    );
CALL BLHSRVLIB.SP_SE_SEL_NOMBRECIFPAGADOR (
...
END IF;
SET VARDESCRIPCIONCREDITO = SUBSTRING (
        TRIM (VARNOMBREPAGADOR) || ' ' || CAST (INTCONTADORFACTOK AS VARCHAR (30)) || ' FACTURAS',
        0,
        30
    );
SET VARMENSAJERESULTADO = 'CTA PAGADOR: ' || NUMCTAPAGADOR_ANT || ' - CTA BENEFICIARIO: ' || CHRCUENTABENEFICIARIO;
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CONSULTA FACTURASEXTERIOR 2 ' || CICLOFACTURAS.IDUNICOFACTURA || ' | PARAM NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA
);
...
SET INTCORRESPONDENTBANKTYPESID = 2;
END IF;
--CALCULO MONTO DEBITO - CREDITO COMISION 
IF (
    SELECT COUNT (*)
    FROM BLHCYFILES.TB_SE_TRN_SITE_COMMISSIONS
    WHERE CLIENTID = NUMCLIENTID
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Parametros SP_SE_VAR_TRANSFERENCIAEXTERIOR2 | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | NUMCIFPAGADOR: ' || NUMCIFPAGADOR || ' | NUMCTAPAGADOR_ANT: ' || NUMCTAPAGADOR_ANT || ' | CHRGLTRANSACCION: ' || CHRGLTRANSACCION || ' | CHRMONEDACUENTAPAGADOR: ' || CHRMONEDACUENTAPAGADOR || ' | CHRCUENTABENEFICIARIO: ' || CHRCUENTABENEFICIARIO || ' | CHRMONEDACTABENEFICIARIO: ' || CHRMONEDACTABENEFICIARIO || ' | DECMONTODEBITO: ' || DECMONTODEBITO || ' | CHRDESCRIPCIONCREDITO: ' || CHRDESCRIPCIONCREDITO || ' | CHRBANCOINTERM: ' || CHRBANCOINTERM || ' | CHRNUMCUENTABANCOINTERM: ' || CHRNUMCUENTABANCOINTERM
);
CALL BLHSRVLIB.SP_SE_VAR_TRANSFERENCIAEXTERIOR (
    NUMCIFPAGADOR,
    CHRIDUNICOFACTURA,
...
CALL BLHSRVLIB.SP_SE_INS_PGLOGPROCESO (
    ...
    0,
    0,
    'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR2 | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | INTTIPORESULTADO: ' || INTTIPORESULTADO || ' | VARMENSAJERESULTADO: ' || VARMENSAJERESULTADO
);
IF INTTIPORESULTADO <> 0 THEN
SET INTTIPORESULTADO = INTTIPORESULTADO;
SET VARMENSAJERESULTADO = VARMENSAJERESULTADO;
...
END P1;
GRANT ALTER,
    EXECUTE ON SPECIFIC PROCEDURE BLHSRVLIB.SP_SE_VAR_PROCESARPAGOS_EXTERIOR TO BLHJGOBAND WITH
GRANT OPTION;
