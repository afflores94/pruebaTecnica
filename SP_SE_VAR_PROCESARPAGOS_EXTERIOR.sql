...
--======================================================================================= 
		...
		IF CHRPROSEGUIR = 'S' THEN
			...
			-- =====================================================================
-- PROCESAMIENTO DEL ÚLTIMO GRUPO
-- =====================================================================
CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Después del loop - Último ID: ' || NUMIDUNICOFACTURA_ANT || ' | Monto acumulado debito: ' || DECMONTODEBITO );

IF DECMONTODEBITO > 0 THEN

    CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'LLEGA 2 - Procesando último grupo' );

    IF NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN

        CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'LLEGA 3 - Preparando transferencia final' );
