	...
	P1 : BEGIN 
		...
		IF CHRPROSEGUIR = 'S' THEN 
			...
			FACT_LOOP : FOR CICLOFACTURAS AS FACTURAS CURSOR WITH HOLD FOR 
				...
				AND F . FORMAPAGO = 3 
				ORDER BY F . CTAPAGADOR , F . IDUNICOBENEFICIARIO , F . FORMAPAGO , F . MONEDAFACTURA , AA . TIPO , F . IDSITIO
			DO 
        		...
        		IF NUMCTAPAGADOR_ANT IS NULL OR NUMCTAPAGADOR_ANT <> CICLOFACTURAS.CTAPAGADOR OR NUMIDBENEFICIARIO_ANT <> CICLOFACTURAS.IDUNICOBENEFICIARIO
					OR NUMFORMAPAGO_ANT <> CICLOFACTURAS.FORMAPAGO OR CHRMONEDAFACTURA_ANT <> CICLOFACTURAS.MONEDAFACTURA OR NUMTIPO <> CICLOFACTURAS.TIPO THEN -- Si el beneficiario actual es diferente al anterior (y no es la primera vez), enviamos lo acumulado.
					...
					SET CHRPROSEGUIR = 'S' ; 
						...
						CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - ENTRA A CICLO FORMAPAGO 3 Y TIPO 2 - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA );
                        ...
                        IF DECMONTODEBITO > 0 THEN 
							...
							IF NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN
	                            ...
	                            SET VARDESCRIPCIONDEBITO = SUBSTRING (TRIM (VARNOMBREBENEFICIARIO) || ' ' || TRIM (CHAR (INTCONTADORFACTOK)) || ' FACTURAS',1,30);
                    	        ...
                    	        SET VARDESCRIPCIONCREDITO = SUBSTRING (TRIM (VARNOMBREPAGADOR) || ' ' || TRIM (CHAR (INTCONTADORFACTOK)) || ' FACTURAS', 1, 30);
                	            ...
                	            CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ENTRA A CONSULTA FACTURASEXTERIOR 1 ' || CICLOFACTURAS.IDUNICOFACTURA || ' | PARAM NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA);
								...
								WHERE IDUNICOFACTURA = NUMIDFACTURAPRIMERA LIMIT 1 ; 
								...
								SET CHRMONEDACUENTAPAGADOR = ( SELECT ACMCCY FROM BLHCYFILES . ACMST WHERE ACMACC = NUMCTAPAGADOR_ANT FETCH FIRST 1 ROW ONLY ) ; 
								 ...
								 --Telefono CUSPHN 
								SELECT CUSNA1 , CUSPHN INTO CHRNOMBREORDENANTE , DECTELEFONOPAGADOR FROM BLHCYFILES . CUMST WHERE CUSCUN = CICLOFACTURAS.CIFPAGADOR ;
								...
								CHRNUMCUENTABANCOINTERM , VARNUMEROREFERENCIA , INTTIPORESULTADO , VARMENSAJERESULTADO ) ; 
  								...
  								CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR1 - CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | INTTIPORESULTADO: ' || INTTIPORESULTADO || ' | VARMENSAJERESULTADO: ' || VARMENSAJERESULTADO );
							...
							CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR NO.LINEA ' || INTTOTALFACT || ' - NOOO ENTRA A CICLO FORMAPAGO 3 Y TIPO 2 - IDUNICOFACTURA: ' || CICLOFACTURAS.IDUNICOFACTURA );
					...
					CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ANTES DE AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | TOTAL FACTURAS: ' || INTTOTALFACT );	
					...
					IF CHRPROSEGUIR = 'S' THEN 
						...
						IF CHRMONEDACTAPAGADOR <> MONEDAFACTURA THEN 
                    	    ...
                    	    CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - PREVIO A INTOPCIONTC AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA );	 
    	                ...
    	                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - VALIDA SALDO AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | NUMSALDODISPONIBLECUENTA: ' || NUMSALDODISPONIBLECUENTA );
					...
					ELSE 
    	            	...
    	            	CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( CICLOFACTURAS.IDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - PROCSEGUIR N AGRUPAR | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA );
            ...
            CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDFACTURAPRIMERA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LINEA | NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA || ' | IDUNICOFACTURA: - | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA );
			...
			IF DECMONTODEBITO > 0 THEN 
				...
				IF NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN 
                    ...
                    CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDFACTURAPRIMERA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CONSULTA FACTURASEXTERIOR 2 ' || CICLOFACTURAS.IDUNICOFACTURA || ' | PARAM NUMIDFACTURAPRIMERA: ' || NUMIDFACTURAPRIMERA);
					...
					CHRNUMCUENTABANCOINTERM , VARNUMEROREFERENCIA , INTTIPORESULTADO , VARMENSAJERESULTADO ) ; 
  					...
  					CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDFACTURAPRIMERA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR2 | CHRIDUNICOFACTURA: ' || CHRIDUNICOFACTURA || ' | INTTIPORESULTADO: ' || INTTIPORESULTADO || ' | VARMENSAJERESULTADO: ' || VARMENSAJERESULTADO );
...
GRANT ALTER , EXECUTE   
ON SPECIFIC PROCEDURE BLHSRVLIB.SP_SE_VAR_PROCESARPAGOS_EXTERIOR 
TO BLHJGOBAND WITH GRANT OPTION ;
