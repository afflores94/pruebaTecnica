...
--======================================================================================= 
		...
		IF CHRPROSEGUIR = 'S' THEN
			...
			CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 1 ' );


			IF DECMONTODEBITO > 0 THEN

				CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 2 ' );

				IF NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN

					CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 3 ' );
					...
					CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 4 ' );
			...
			ELSE
				...
				CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 5 ' );
		...
		ELSE
			...
			CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 5.1 ' );
		...
		CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 6 ' );
		...
		CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 7 ' );

		--** Se guarda en la tabla final del log los datos 
		--INSERT INTO BLHCYFILES . TB_SE_TRN_PGLOGPROCESO
		--SELECT * FROM SESSION . PGLOGPROCESOTMP ;

		CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 8 ' );
		...
		CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 9 ' );
		
		--** Se borran los registros guardados en las tablas temporales. 
		DELETE FROM SESSION . PGLOGPROCESOTMP ;
		DELETE FROM SESSION . PGCOLANOTIFICACIONESTMP ;

		CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - LLEGA 10 ' );
