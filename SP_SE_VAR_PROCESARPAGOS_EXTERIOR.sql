...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: 606470 | AHUEVO QUE NO ENTRA 3
...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - VALIDA SALDO AGRUPAR - NUMSALDODISPONIBLECUENTA: 159242.12
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - TOTAL FACTURAS APLICADAS: 1 | NUMIDUNICOFACTURA: 606470
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - APLICADA
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: 606463 | AHUEVO QUE ENTRA 2
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Parametros SP_SE_VAR_TRANSFERENCIAEXTERIOR2 - CHRIDUNICOFACTURA: 606470 | NUMCIFPAGADOR: 198503 | NUMCTAPAGADOR_ANT: 114504001596 | CHRGLTRANSACCION: 2439934000000000                    | CHRMONEDACUENTAPAGADOR: USD | CHRCUENTABENEFICIARIO: 072180013272988688                  | CHRMONEDACTABENEFICIARIO: USD | DECMONTODEBITO: 10045.00 | CHRDESCRIPCIONCREDITO: Pago Factura                                                                                                                       | CHRBANCOINTERM:                 | CHRNUMCUENTABANCOINTERM: 0                                                                                                                                                                                                                                                         
...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR1 - CHRIDUNICOFACTURA: 606470 | INTTIPORESULTADO: 0 | VARMENSAJERESULTADO: OK
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - SMS OK
...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - VALIDA SALDO AGRUPAR - NUMSALDODISPONIBLECUENTA: 149177.02
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - TOTAL FACTURAS APLICADAS: 1 | NUMIDUNICOFACTURA: 606463
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - APLICADA
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: 606471 | AHUEVO QUE ENTRA 2
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Parametros SP_SE_VAR_TRANSFERENCIAEXTERIOR2 - CHRIDUNICOFACTURA: 606463 | NUMCIFPAGADOR: 198503 | NUMCTAPAGADOR_ANT: 114504001596 | CHRGLTRANSACCION: 2439934000000000                    | CHRMONEDACUENTAPAGADOR: USD | CHRCUENTABENEFICIARIO: 2157241249                          | CHRMONEDACTABENEFICIARIO: USD | DECMONTODEBITO: 10033.00 | CHRDESCRIPCIONCREDITO: transferencia internacional seacost national bank                                                                                  | CHRBANCOINTERM:                 | CHRNUMCUENTABANCOINTERM: 0                                                                                                                                                                                                                                                         
...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Resultado SP_SE_VAR_TRANSFERENCIAEXTERIOR1 - CHRIDUNICOFACTURA: 606463 | INTTIPORESULTADO: 0 | VARMENSAJERESULTADO: OK
...
SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: 606471 | AHUEVO QUE NO ENTRA 4
    ...
    P1 : BEGIN
		...
		IF CHRPROSEGUIR = 'S' THEN
            ...
            DO
                ...
                IF (NUMCTAPAGADOR_ANT IS NULL OR NUMCTAPAGADOR_ANT <> CICLOFACTURAS.CTAPAGADOR OR NUMIDBENEFICIARIO_ANT <> CICLOFACTURAS.IDUNICOBENEFICIARIO OR
                    ...
                    IF NUMCTAPAGADOR_ANT IS NOT NULL AND DECMONTODEBITO > 0 THEN
                        ...
                        CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA || ' | AHUEVO QUE ENTRA 2' );
                        ...
                        IF NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN
                            ...
                            IF INTTIPORESULTADO = 0 THEN
								...
								IF VARCELULARBENEFICIARIO <> '' THEN
                                    ...
                                    CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( 0 , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ' || VARMSJERRORSMS );
                    ...
                    ELSE
                        ...
                        CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA || ' | AHUEVO QUE NO ENTRA 3' );
					...
					IF NUMSALDODISPONIBLECUENTA >= DECMONTODEBITOTEMP THEN
						...
						ELSEIF NUMTIPO = 2 THEN
							...
							IF EXISTS ( SELECT 1 FROM BLHCYFILES . DLPMT WHERE UNMF10 = NUMIDUNICOFACTURA ) THEN
                                ...
                                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( 0 , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Cuota pendiente de pago por procesos del cierre' );
							ELSE
                                ...
                                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( 0 , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - Cuota pendiente Cancelada, se actualiza estado factura' );
                ...
                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - APLICADA' );
            ...
            IF DECMONTODEBITO > 0 AND NUMFORMAPAGO_ANT = 3 AND NUMTIPO <> 2 THEN
                ...
                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA_ANT || ' | AHUEVO QUE ENTRA 1' );
                ...
                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - PRIMER SELECT - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA_ANT || ' | CHRNOMBREORDENANTE: ' || CHRNOMBREORDENANTE || ' | DECTELEFONOPAGADOR: ' || DECTELEFONOPAGADOR );

				SELECT ACMCCN INTO DECCENTROCOSTODEBITO FROM BLHSRVLIB . A_ACMST WHERE ACMACC = NUMCTAPAGADOR_ANT FETCH FIRST 1 ROWS ONLY ;

                CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA_ANT , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - SEGUNDO SELECT - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA_ANT || ' | DECCENTROCOSTODEBITO: ' || DECCENTROCOSTODEBITO );
				...
				IF INTTIPORESULTADO = 0 THEN
					...
					ELSE
						...
						SET VARMSJERRORSMS = 'SIN  CELULAR' ;
                        CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ' || VARMSJERRORSMS );
                ...
                ELSE
                    ...
                    CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - CHRIDUNICOFACTURA: ' || NUMIDUNICOFACTURA_ANT || ' | AHUEVO QUE NO ENTRA 4' );

			END IF ;

		ELSE
			
            CALL BLHSRVLIB . SP_SE_INS_PGLOGPROCESO ( NUMIDUNICOFACTURA , 0 , 0 , 0 , 0 , 0 , 'SP_SE_VAR_PROCESARPAGOS_EXTERIOR - ' || VARMENSAJERESULTADO );
