...
OR NUMTIPO <> TIPO THEN -- Si el beneficiario actual es diferente al anterior (y no es la primera vez), enviamos lo acumulado.
...
SET NUMIDFACTURAPRIMERA = IDUNICOFACTURA;
