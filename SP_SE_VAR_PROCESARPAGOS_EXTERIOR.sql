...
WHERE IDUNICOFACTURA = NUMIDBENEFICIARIO_ANT
LIMIT 1;
...
END IF;
SET CHRHORA = REPLACE (
        CAST (CURRENT TIME AS VARCHAR (8)),
        '.',
        ''
    );
...
SET NUMIDBENEFICIARIO_ANT = IDUNICOFACTURA;
...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'Despues obtener fecha: ' || INTTIPORESULTADO || ' ' || VARMENSAJERESULTADO || ' ' || CHRPROSEGUIR
    );
UPDATE BLHCYFILES.TB_SE_TRN_PGTRANSACCIONESFACTURAS
SET ESTADOFACTURA = (
        CASE
...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'Despues update factura: ' || INTTIPORESULTADO || ' ' || VARMENSAJERESULTADO || ' ' || CHRPROSEGUIR
    );
...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'Cuota pendiente Cancelada, se actualiza estado factura'
    );
END IF;
END IF;
ELSE
