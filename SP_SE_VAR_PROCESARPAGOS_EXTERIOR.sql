	...
	P1 : BEGIN 
		...
		IF CHRPROSEGUIR = 'S' THEN 
			...
			DO 
				...
				-- Si el beneficiario actual es diferente al anterior (y no es la primera vez), enviamos lo acumulado.
			    IF NUMIDBENEFICIARIO_ANT IS NOT NULL AND (NUMIDBENEFICIARIO_ANT <> CICLOFACTURAS.IDUNICOBENEFICIARIO OR 
			        NUMCTAPAGADOR_ANT <> CICLOFACTURAS.CTAPAGADOR OR CHRMONEDAFACTURA_ANT <> CICLOFACTURAS.MONEDAFACTURA) THEN
