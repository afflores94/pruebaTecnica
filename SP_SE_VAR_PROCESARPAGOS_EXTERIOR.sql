...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'ID: ' || TRIM (CHAR (NUMIDUNICOFACTURA)) || ' - Despues obtener fecha: ' || TRIM (CHAR (INTTIPORESULTADO)) || ' ' || VARMENSAJERESULTADO || ' ' || CHRPROSEGUIR
    );
UPDATE BLHCYFILES.TB_SE_TRN_PGTRANSACCIONESFACTURAS
SET ESTADOFACTURA = (
        CASE
...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'ID: ' || TRIM (CHAR (NUMIDUNICOFACTURA)) || ' - Despues update factura: ' || TRIM (CHAR (INTTIPORESULTADO)) || ' ' || VARMENSAJERESULTADO || ' ' || CHRPROSEGUIR
    );
...
VALUES (
        ...
        NUMTASADECOMPRA,
        NUMTASADEVENTA,
        'ID: ' || TRIM (CHAR (NUMIDUNICOFACTURA)) || ' - Cuota pendiente Cancelada'
    );
END IF;
END IF;
ELSE
