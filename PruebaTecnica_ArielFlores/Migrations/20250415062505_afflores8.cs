...
{
    /// <inheritdoc />
    public partial class afflores8 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoTransaccion = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transacciones_cuentas_CuentasId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacciones_CuentasId",
                table: "Transacciones",
                column: "CuentasId");
        }
